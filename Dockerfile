...
RUN case `uname -m` in \
      x86_64)  url="https://github.com/jgm/pandoc/releases/download/3.1.6/pandoc-3.1.6-1-amd64.deb" ;; \
      aarch64) url="https://github.com/jgm/pandoc/releases/download/3.1.6/pandoc-3.1.6-1-arm64.deb" ;; \
      *)       url="" ;; \
    esac; \
    wget "$url" -q --output-document=/home/pandoc.deb && dpkg -i pandoc.deb && rm pandoc.deb
